...
USERNAME = "holadmin"
SSH_PORT = 22
THREADS_COUNT = 3  # Number of processes to handle file parts
CHUNK_SIZE = 100 * 1024 * 1024  # 100 MB for each chunk
...
def upload_part(remote_host, remote_path, local_path, num, offset, part_size, progress_queue):
    ...
    while attempt < MAX_RETRIES:
        try:
            print(f"Process {num} attempting connection (Attempt {attempt + 1})")
            ssh = SSHClient()
